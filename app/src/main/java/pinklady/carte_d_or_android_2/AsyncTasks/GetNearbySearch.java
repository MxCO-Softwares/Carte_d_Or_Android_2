 ...
 */
public class GetNearbySearch extends AsyncTask<Void, Void, Places> {
    ...
    protected GetNearbySearch(String key, LatLng location, int radius) {
        this.mKey = key;
    ...
    protected Places doInBackground(Void... params) {
        ...
        String data = "";
        String request = "https://maps.googleapis.com/maps/api/place/nearbysearch/" +
